...
from sglang.srt.layers.moe.token_dispatcher.base_dispatcher import BaseDispatcher, BaseDispatcherConfig
...
if TYPE_CHECKING:
    from sglang.srt.layers.moe.a2a_output import DispatchOutput, DeepEPNormalOutput, DeepEPLLOutput
